...
def main():
    ...
    # Init the variable for the user's choice
    choice = 0
...
# The look_up function looks up an item 
...
def add(mycontacts):
    ...
    # Create a contact object names entry
...
# The save_contacts function pickels the specified 

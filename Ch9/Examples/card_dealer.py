...
# Create deck function returns a dictionary
...
# The deal cards function deals a specified number of cards from the deck

def deal_cards(deck, number):
    # Init the accumulator for the hand value
    hand_value = 0

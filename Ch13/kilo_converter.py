# This program converts distances in kilometeres
...
class KiloConverterGUI:
    ...
    # The convert method is a callback function
    # for the calculate button
    def convert(self):
        # Get the value enytered by the user
        # into the kilo_entry widget
        ...
        # Display the result
        tkinter.messagebox.showinfo('Results', str(kilo) + ' kilometres is equal to ' + 
                                    str(miles) + ' miles.')
